...
var _ = Describe("", func() {
	...
	It("RHACM4K-2881: Observability: Check and tune backup retention settings in MCO CR - tune retention settings in MCO CR [P2][Sev2][Observability][Stable] @e2e @post-release (reconcile/g0)", func() {
	...
	It("RHACM4K-1655: Observability: Verify nodeSelector setting effects for Observability components [P2][Sev2][Observability][Stable] @e2e @post-release (reconcile/g0)", func() {
	...
	It("RHACM4K-1657: Observability: Check affinity rule takes effect on Observability components [P2][Sev2][Observability][Stable] @e2e @post-release (reconcile/g0)", func() {
	...
	It("RHACM4K-2821: Observability: Customize the Observability components storage size [P2][Sev2][Observability][Stable] @e2e @post-release (reconcile/g0)", func() {
		cloudProvider := strings.ToLower(os.Getenv("CLOUD_PROVIDER"))
		substring1 := "vmware"
		substring2 := "ibm"
		if strings.Contains(cloudProvider, substring1) || strings.Contains(cloudProvider, substring2) {
	...
	It("RHACM4K-2881: Observability: Check and tune backup retention settings in MCO CR - Revert MCO CR changes [P2][Sev2][Observability][Stable] @e2e @post-release (reconcile/g0)", func() {
		cloudProvider := strings.ToLower(os.Getenv("CLOUD_PROVIDER"))
		substring1 := "vmware"
		substring2 := "ibm"
		if strings.Contains(cloudProvider, substring1) || strings.Contains(cloudProvider, substring2) {
