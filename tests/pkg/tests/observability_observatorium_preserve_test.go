...
var _ = Describe("", func() {
	...
	Context("RHACM4K-1443: Observability: Verify Observatorium CR configuration compliance [P1][Sev1][Observability]@ocpInterop @post-upgrade @post-restore @e2e @post-release (observatorium_preserve/g0) -", func() {
