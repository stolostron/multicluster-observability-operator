...
var _ = Describe("", func() {
	...
	It("RHACM4K-1064: Observability: Verify MCO deployment - [P1][Sev1][Observability][Stable]@ocpInterop @e2e @post-release @pre-upgrade (deployment/g0)", func() {
	...
	It("RHACM4K-1288: Observability: Verify Observability function working on the hub cluster - [P1][Sev1][Observability][Stable]@ocpInterop @e2e @post-release @pre-upgrade (deployment/g0)", func() {
	...
	It("RHACM4K-30645: Observability: Verify setting in CM cluster-monitoring-config is not removed after MCO enabled - [P1][Sev1][Observability][Stable]@ocpInterop @e2e @post-release @pre-upgrade (deployment/g1)", func() {
