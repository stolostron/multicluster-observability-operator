...
deploy_hub_core() {
    ...
    $sed_command "s~registration-operator:latest~registration-operator:0.0.1~g" deploy/klusterlet/operator.yaml
    $sed_command "s~registration-operator:latest~registration-operator:0.0.1~g" deploy/cluster-manager/operator.yaml
    $sed_command "s~quay.io/open-cluster-management/registration~quay.io/open-cluster-management/registration:0.0.1~g" deploy/klusterlet/crds/operator_open-cluster-management_klusterlets.cr.yaml
    $sed_command "s~quay.io/open-cluster-management/registration~quay.io/open-cluster-management/registration:0.0.1~g" deploy/cluster-manager/crds/operator_open-cluster-management_clustermanagers.cr.yaml
