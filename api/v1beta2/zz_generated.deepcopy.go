...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RBACQueryProxySpec) DeepCopyInto(out *RBACQueryProxySpec) {
	*out = *in
	if in.Resources != nil {
		in, out := &in.Resources, &out.Resources
		*out = new(v1.ResourceRequirements)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RBACQueryProxySpec.
func (in *RBACQueryProxySpec) DeepCopy() *RBACQueryProxySpec {
	if in == nil {
		return nil
	}
	out := new(RBACQueryProxySpec)
