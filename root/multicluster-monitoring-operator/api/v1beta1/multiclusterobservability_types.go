...
type MultiClusterObservabilitySpec struct {
	...
	// Foo is an example field of MultiClusterObservability. Edit MultiClusterObservability_types.go to remove/update
...
// MultiClusterObservability is the Schema for the multiclusterobservabilities API
