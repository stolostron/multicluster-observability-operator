...
func (in *DeploymentConditionResult) DeepCopyInto(out *DeploymentConditionResult) {
	*out = *in
	in.Status.DeepCopyInto(&out.Status)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DeploymentConditionResult.
func (in *DeploymentConditionResult) DeepCopy() *DeploymentConditionResult {
	if in == nil {
		return nil
	}
	out := new(DeploymentConditionResult)
	in.DeepCopyInto(out)
	return out
}
...
func (in *MultiClusterObservabilityStatus) DeepCopyInto(out *MultiClusterObservabilityStatus) {
	*out = *in
	if in.Conditions != nil {
		...
		*out = make([]DeploymentConditionResult, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
