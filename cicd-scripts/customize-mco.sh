...
get_ginkgo_focus() {
  if [[ -n ${IS_KIND_ENV} ]]; then
    ...
    GINKGO_FOCUS=" --focus manifestwork/g --focus endpoint_preserve/g --focus grafana/g --focus metrics/g --focus addon/g --focus alert/g --focus dashboard/g --focus obs_rbac/g --skip requires-ocp/g0"
  else
    GINKGO_FOCUS=""
  fi
