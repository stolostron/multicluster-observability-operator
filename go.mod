...
require (
	github.com/IBM/controller-filtered-cache v0.0.0-00010101000000-000000000000
...
replace github.com/IBM/controller-filtered-cache => github.com/coleenquadros/controller-filtered-cache v0.0.0-upgrade-k8s-libs

replace github.com/coreos/prometheus-operator => github.com/prometheus-operator/prometheus-operator v0.74.0
