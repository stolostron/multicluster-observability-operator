...
then you can following these steps to deploy multicluster-observability-operator: https://github.com/open-cluster-management/multicluster-monitoring-operator#install-this-operator-on-rhacm
