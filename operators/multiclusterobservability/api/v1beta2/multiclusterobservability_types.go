...
type PlatformCapabilitiesSpec struct {
	...
	// Analytics defines the spec for the analytics capabilities.
	// Currently it support Right Sizing recommendation feature.
	//
	// +optional
	// +kubebuilder:validation:Optional
	Analytics *AnalyticCapabilitiesSpec `json:"analytics,omitempty"`
}
